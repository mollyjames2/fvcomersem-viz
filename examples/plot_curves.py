...
def main():
    ...
    print(hr("="))
    print("Curves Diagnostics Examples")
    print(hr("="))
    ...
    base_out = out_dir(
        BASE_DIR, FIG_DIR
    )  # root; plot_curves decides subdir ("curves" by default)
    ...
    # ========================================================================= #
    info(
        " Example 2: Temperature vs Total Phytoplankton C - depth_avg - Apr-Oct 2018 - Domain"
    )
    ...
    # ========================================================================= #
    info(
        " Example 3: Temperature vs P5_Cfix (rate) - depth_avg - Apr-Oct 2018 - Domain"
    )
    ...
    # ============================================================================
    info(
        " Example 4: Temperature vs P5_Cfix (rate) - depth_avg - Apr-Oct 2018 - Domain"
    )
