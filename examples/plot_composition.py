...
def main():
    ...
    print(hr("="))
    print("Phyto/Zoo Composition Examples")
    print(hr("="))
    ...
    if phy_path:
        kv("Saved (Phyto TS, regions)", phy_path)
    if zoo_path:
    ...
    if phy_path:
        kv("Saved (Phyto TS, stations)", phy_path)
    if zoo_path:
        kv("Saved (Zoo TS, stations)", zoo_path)
